...
class ComparisonGrid(QWidget):
    ...
    def __init__(self, columns: int = 3, parent: QWidget | None = None):
        ...
        self.input_cell: ComparisonCell | None = None
        self.reference_cell: ComparisonCell | None = None
    ...
    def set_methods(
        ...
        if show_input:
            self.input_cell = ComparisonCell(
                method_key="input", method_name="Original Input", is_reference=True
            )
        ...
        for method_key in method_keys:
            ...
            cell = ComparisonCell(
                method_key=method_key, method_name=method_name, is_reference=False
            )
    ...
    def set_method_result(
        self, method_key: str, pixmap: QPixmap, timing_text: str | None = None
    ):
    ...
    def get_cell(self, method_key: str) -> ComparisonCell | None:
