...
from model import ZeroDCE, build_dce_net, get_enhanced_image
...
print("   ✅ DCE-Net built successfully")
...
print(
    f"   Input range: [{tf.reduce_min(dummy_image):.3f}, {tf.reduce_max(dummy_image):.3f}]"
)
print(
    f"   Enhanced range: [{tf.reduce_min(enhanced):.3f}, {tf.reduce_max(enhanced):.3f}]"
)
...
print("   ✅ Enhancement modifies the image")

# Test 3: Test ZeroDCE model
print("\n3. Testing ZeroDCE model...")
zero_dce = ZeroDCE()
print("   ✅ ZeroDCE model instantiated")
...
print("   ✅ All 5 metrics initialized")
...
print("   ✅ Total loss equals sum of components")
...
print("   Metrics before training step:")
...
for name, value in test_metrics.items():
    print(f"      {name}: {value:.6f}")
print("   ✅ Validation step executed successfully")
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    print("   ✅ Weights saved to temporary file")
    ...
    print("   ✅ Loaded weights produce identical outputs")
...
for h, w in test_sizes:
    ...
    assert test_output.shape == test_img.shape, f"Output shape mismatch for {h}x{w}"
