...
class TestGeneralTab:
    ...
    def test_save_settings_path_is_file(
        self, general_tab, qtbot, tmp_path, monkeypatch
    ):
    ...
    def test_unlimited_warning_exists(self, general_tab):
        ...
        assert (
            "Unlimited" in general_tab.unlimited_warning_label.text()
            or "unlimited" in general_tab.unlimited_warning_label.text()
        )
...
class TestPreferencesDialog:
    ...
    def test_escape_key_with_changes_reject(
        self, preferences_dialog, qtbot, monkeypatch
    ):
    ...
    def test_apply_button_handler(
        self, preferences_dialog, qtbot, tmp_path, monkeypatch
    ):
...
class TestPreferencesDialogEdgeCases:
    ...
    def test_rapid_setting_changes(self, preferences_dialog):
        ...
        assert (
            preferences_dialog.general_tab.auto_load_checkbox.isChecked()
            != initial_state
        )
