...
class TestEnhancementResultCreation:
    ...
    def test_enhancement_result_created_on_finish(
        ...
        with patch(
            "gui.main_window.ImageProcessor.pil_to_pixmap"
        ) as mock_pil_to_pixmap:
...
class TestEnhancementTimingIntegration:
    ...
    def test_complete_enhancement_timing_workflow(
        self, main_window, sample_image, qtbot
    ):
